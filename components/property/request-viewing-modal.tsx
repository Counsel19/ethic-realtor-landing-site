...
export function RequestViewingModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Close the request modal and show success modal
    onOpenChange(false)
    setShowSuccess(true)
  }
  ...
  const handleWhatsAppClick = () => {
    const phoneNumber = "+234703246890"
    const message = "Hello, I'm interested in viewing a property."
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="pt-6 mt-6 border-t">
            <div className="bg-accent/50 rounded-xl p-4 text-center space-y-3">
              ...
              >
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <span className="text-lg font-bold text-[#CA8A00]">
                    +234 70 324 6890
                  </span>
                </div>
              </button>
